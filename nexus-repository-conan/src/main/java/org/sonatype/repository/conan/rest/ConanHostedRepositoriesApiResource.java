...
public abstract class ConanHostedRepositoriesApiResource
    extends AbstractRepositoriesApiResource<ConanHostedRepositoryApiRequest>
{
  @ApiOperation("Create Conan hosted repository")
  @ApiResponses(value = {
  ...
  @Validate
  @Override
  public Response createRepository(final ConanHostedRepositoryApiRequest request) {
    return super.createRepository(request);
  }

  @ApiOperation("Update Conan hosted repository")
  @ApiResponses(value = {
  ...
  public Response updateRepository(
      final ConanHostedRepositoryApiRequest request,
