  ...
  extends ConanRecipeSupport
{
  ...
  static TokenMatcher conanManifestMatcher() {
    new TokenMatcher("/{${AUTHOR}:.+}/{${PROJECT}:.+}/{${VERSION}:.+}/{${STATE}:.+}/conanmanifest.txt")
  }
  ...
  static TokenMatcher conanFileMatcher() {
    new TokenMatcher("/{${AUTHOR}:.+}/{${PROJECT}:.+}/{${VERSION}:.+}/{${STATE}:.+}/conanfile.py")
  }
  ...
  static TokenMatcher conanInfoMatcher() {
    new TokenMatcher("/{${AUTHOR}:.+}/{${PROJECT}:.+}/{${VERSION}:.+}/{${STATE}:.+}/conaninfo.txt")
  }
